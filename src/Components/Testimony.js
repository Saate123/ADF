    ...
    <div className="testimony">
      <div className="test">
        <div className="test-l">
          ...
          <p>
            We at the African diaspora properties registered in the UK, USA and
            Nigeria to help African in diaspora own their dream home in the best
            of neighbourhood in a location closer to their home where they can
            visit and live with their children and feel the beauty and comfort
            of peace, security, health and wellbeing and excellence.
          </p>
        </div>
